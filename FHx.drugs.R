...
require(openxlsx)
library(stringr)
dat.source=1; #0:data dump ; 1:nda package (default); both data sources should land to the same outcome;
...
threshold=1;
prob_cate="drugs"
prob_cate_dic="drug use"
############################################################
##For parents and grandparents
############################################################
shared.var="famhx_1"
master.var="fam_history_5_yes_no";
Input.vars.all<-c(shared.var,master.var)
p.gp.sub.var.header.vec=c("fam_history_q5a_drugs","fam_history_q5b_drugs","fam_history_q5c_drugs","fam_history_q5d_drugs","fam_history_q5e_drugs","fam_history_q5f_drugs")
...
ua.sub.var.header.vec=paste0(c("q5g_pat_uncle1_","q5g_pat_uncle2_","q5g_pat_uncle3_","q5g_pat_uncle4_","q5g_pat_uncle5_",
"q5h_pat_aunt1_","q5h_pat_aunt2_","q5h_pat_aunt3_","q5h_pat_aunt4_","q5h_pat_aunt5_",
"q5i_mat_uncle1_","q5i_mat_uncle2_","q5i_mat_uncle3_","q5i_mat_uncle4_","q5i_mat_uncle5_",
"q5j_mat_aunt1_","q5j_mat_aunt2_","q5j_mat_aunt3_","q5j_mat_aunt4_","q5j_mat_aunt5_"),prob_cate)
...
sib.sub.var.header.vec=paste0(c("q5k_full_sib_young1_","q5k_full_sib_young2_","q5k_full_sib_young3_","q5k_full_sib_young4_","q5k_full_sib_young5_","q5l_full_sib_old1_","q5l_full_sib_old2_","q5l_full_sib_old3_","q5l_full_sib_old4_","q5l_full_sib_old5_",
"q5m_half_sib_young1_","q5m_half_sib_young2_","q5m_half_sib_young3_","q5m_half_sib_young4_","q5m_half_sib_young5_",
"q5n_half_sib_old1_","q5n_half_sib_old2_","q5n_half_sib_old3_","q5n_half_sib_old4_","q5n_half_sib_old5_"),prob_cate)
...
#################################################
#drugs section, younger sibilings, missing one "_" in nda data (probably reached their limit of the length of variable name);
#colnames(dat.bl)[grepl("drugs__999",colnames(dat.bl))];
# [1] "q5k_full_sib_young2_drugs__999" "q5k_full_sib_young3_drugs__999" "q5k_full_sib_young4_drugs__999" "q5k_full_sib_young5_drugs__999"
# [5] "q5m_half_sib_young2_drugs__999" "q5m_half_sib_young3_drugs__999" "q5m_half_sib_young4_drugs__999" "q5m_half_sib_young5_drugs__999"

if (dat.source==1 & master.var=="fam_history_5_yes_no"){
	ind=which(grepl("drugs__999",colnames(dat.bl)));

	if(length(ind)>0){
		colnames(dat.bl)[ind]=gsub("__","___",colnames(dat.bl)[ind])
	}
...
if (dat.source==1 & master.var=="fam_history_5_yes_no"){
	new.dic.vars=new.dic.vars[!grepl("drugs___999",new.dic.vars)]	
...
#two data sources should land to the same values of summary scores;
if(dat.source==0){
